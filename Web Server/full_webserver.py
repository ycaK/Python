...
class webServer:
    ...
    def generate_server_header(self, code): # Generates the heading of server
        if code == 200:
            try:
                ...
                print(str(error) + time.strftime(" [ %a, %d, %b, %H:%M:%S ]", time.localtime()))
    ...
    def run(self): # Main function
        try:
            ...
            print("[ ! ] Error - Couldn't bind IP!") # Indicating that server couldn't start
            quit(1) # Quiting
